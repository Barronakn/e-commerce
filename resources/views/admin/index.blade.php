...
@section('content')
    <div class="content container px-6 mx-auto grid">
        <h2 class="mt-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Products
        </h2>

        <div>
            <section class="products mx-auto my-8">
                            ...
                            @foreach ($products as $product)
                                <tr>
                                    <td class="border p-3 flex justify-center items-center">
                                        <img style="width:100px;" src="{{ $product->image_path }}"
                                    ...
                                    <td class="border p-3">
                                        <div class="flex justify-center items-center">
                                            <a href="products/admin/show/{{ $product['id'] }}" style="color: green"
                                                class="mr-2">View</a>
                                            <a href="products/admin/edit/{{ $product['id'] }}" style="color: blue"
                                                class="mr-2">Edit</a>
                                            <form action="products/admin/delete/{{ $product['id'] }}" style="color: red"
                                                method="POST" class="block">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class=""
                                                    onclick="return confirm('Voulez-vous vraiment supprimer ce produit ?')">Delete</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
