                ...
                <div class="container">
                    <form action="{{ route("admin.produit.update", $product->id) }}"  enctype="multipart/form-data" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" value="{{ $product->name }}" class="border border-gray-400 p-2 w-full" />
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="price" name="price" value="{{ $product->price }}" class="border  border-gray-400 p-2 w-full" />
                        </div>
                        <div class="mb-4 dark:text-gray-200">
                            <label for="name" class="block font-medium">Image:</label>
                            <input type="file" id="image" name="image" value="{{ $product->image_path }}" class="border border-gray-400 p-2 w-full" />
                        </div>
                        <button type="submit" class="bg-purple-500 hover:bg-purple-700 dark:text-gray-200 font-bold py-2 px-4 rounded">Update</button>
