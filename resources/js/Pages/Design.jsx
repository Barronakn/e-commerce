...
const Design = ({ products, items }) => {
    ...
    useEffect(() => {
        products
            .filter((cv) => cv.typedecv.match(/Design/i))
            .forEach((product) => {
    ...
    const cvType = products.filter((cv) => cv.typedecv.match(/Design/i));
    ...
    return (
        <div>
            <Head
                title="Casineuve Actions | +200 Modèles de CV Design sur deux pages à télécharger et à remplir"
            ...
            <section className="mt-32 mx-10 sm:mx-20">
                <PageNav
                    link="/cv_professionnel-cv_word-cv_powerPoint-cv_junior-cv_simples-cv_senior-cv_ modernes-cv-sur_deux_pages"
                    linkName="Modèles de CV à Télécharger"
                />
            </section>
                            ...
                            <div className="bg-white grid xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1">
                                ...
                                {currentModelsFilteredProducts &&
                                    currentModelsFilteredProducts.map((cv) => (
                                        <div
                                            key={cv.id}
                                            className="filtreByColor block p-5"
                                        >
                                            <ModeleOneList
                                                id={cv.id}
                                                name={cv.modeles}
            ...
            <section className="others mt-20">
                <Others />
            </section>
