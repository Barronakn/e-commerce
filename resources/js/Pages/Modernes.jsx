...
const Modernes = ({ products, items }) => {
    ...
    useEffect(() => {
        products
            .filter((cv) => cv.typedecv.match(/Modernes/i))
            .forEach((product) => {
    ...
    const cvType = products.filter((cv) => cv.typedecv.match(/Modernes/i));
    ...
    return (
        <div>
            <Head
                title="Casineuve Actions | +200 Modèles de CV Modernes sur deux pages à télécharger et à remplir"
