...
const AllModeles = ({ products, items }) => {
    ...
    // Récupérer les modèles actuels à afficher
    const currentModelsFilteredProducts =
        filteredProducts &&
        filteredProducts.slice(indexOfFirstModel, indexOfLastModel);

    const totalPagesFilteredProducts =
        filteredProducts && Math.ceil(filteredProducts.length / modelsPerPage);
